...
QUESTIONS = [
    ...
    {
        "question": "How much does laundry cost in Old Brewhouse, and are the machines coin-only?",
        "expects": "1.50",
    },
    {
        "question": "Until when can you declare pass/fail on a course outside your major?",
        "expects": "week eight",
    },
    {
